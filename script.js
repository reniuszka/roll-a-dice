...
//declaring them without any value to be accesible for other functions - it is a scope rule
let scores;
let currentScore;
let activePlayer;
let playing;
...
const init = function () {
  //reaasigning their value of scores, currentScore, activePlayer and playing
